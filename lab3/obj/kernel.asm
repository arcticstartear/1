...
ffffffffc020004c:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004e:	25a040ef          	jal	ra,ffffffffc02042a8 <memset>
...
ffffffffc0200072:	54c030ef          	jal	ra,ffffffffc02035be <vmm_init>
...
ffffffffc02000b0:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000b2:	50f030ef          	jal	ra,ffffffffc0203dc0 <vprintfmt>
    return cnt;
}
...
ffffffffc02000e4:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e6:	4db030ef          	jal	ra,ffffffffc0203dc0 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc020010c:	22850513          	addi	a0,a0,552 # ffffffffc0204330 <etext+0x5e>
void print_kerninfo(void) {
...
ffffffffc0200122:	23250513          	addi	a0,a0,562 # ffffffffc0204350 <etext+0x7e>
ffffffffc0200126:	f99ff0ef          	jal	ra,ffffffffc02000be <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc020012a:	00004597          	auipc	a1,0x4
ffffffffc020012e:	1a858593          	addi	a1,a1,424 # ffffffffc02042d2 <etext>
ffffffffc0200132:	00004517          	auipc	a0,0x4
ffffffffc0200136:	23e50513          	addi	a0,a0,574 # ffffffffc0204370 <etext+0x9e>
...
ffffffffc020014a:	24a50513          	addi	a0,a0,586 # ffffffffc0204390 <etext+0xbe>
...
ffffffffc020015e:	25650513          	addi	a0,a0,598 # ffffffffc02043b0 <etext+0xde>
...
ffffffffc020018c:	24850513          	addi	a0,a0,584 # ffffffffc02043d0 <etext+0xfe>
}
...
ffffffffc020019c:	16860613          	addi	a2,a2,360 # ffffffffc0204300 <etext+0x2e>
ffffffffc02001a0:	04e00593          	li	a1,78
ffffffffc02001a4:	00004517          	auipc	a0,0x4
ffffffffc02001a8:	17450513          	addi	a0,a0,372 # ffffffffc0204318 <etext+0x46>
void print_stackframe(void) {
...
ffffffffc020029e:	6af030ef          	jal	ra,ffffffffc020414c <readline>
...
ffffffffc02002b0:	7db030ef          	jal	ra,ffffffffc020428a <strchr>
...
ffffffffc02002d4:	78d030ef          	jal	ra,ffffffffc0204260 <strcmp>
...
ffffffffc02002e8:	779030ef          	jal	ra,ffffffffc0204260 <strcmp>
...
ffffffffc020034e:	73d030ef          	jal	ra,ffffffffc020428a <strchr>
...
ffffffffc02004c0:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004c2:	5f9030ef          	jal	ra,ffffffffc02042ba <memcpy>
    return 0;
}
...
ffffffffc02004e6:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004e8:	5d3030ef          	jal	ra,ffffffffc02042ba <memcpy>
    return 0;
}
...
ffffffffc0200554:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200556:	5a60306f          	j	ffffffffc0203afc <do_pgfault>
    panic("unhandled page fault.\n");
...
ffffffffc0201804:	2a5020ef          	jal	ra,ffffffffc02042a8 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02018aa:	1ff020ef          	jal	ra,ffffffffc02042a8 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201f7e:	2d0020ef          	jal	ra,ffffffffc020424e <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f82:	100b8593          	addi	a1,s7,256
ffffffffc0201f86:	10000513          	li	a0,256
ffffffffc0201f8a:	2d6020ef          	jal	ra,ffffffffc0204260 <strcmp>
...
ffffffffc0201fc6:	10068023          	sb	zero,256(a3) # fffffffffffff100 <end+0x3fdedb68>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fca:	240020ef          	jal	ra,ffffffffc020420a <strlen>
...
ffffffffc0202826:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202828:	3a8010ef          	jal	ra,ffffffffc0203bd0 <swapfs_init>
...
ffffffffc02028f0:	313000ef          	jal	ra,ffffffffc0203402 <mm_create>
...
ffffffffc020292a:	325000ef          	jal	ra,ffffffffc020344e <vma_create>
...
ffffffffc0202936:	385000ef          	jal	ra,ffffffffc02034ba <insert_vma_struct>
...
ffffffffc0202b4a:	23f000ef          	jal	ra,ffffffffc0203588 <mm_destroy>
...
ffffffffc0202f70:	53f000ef          	jal	ra,ffffffffc0203cae <swapfs_write>
...
ffffffffc020300e:	3fb000ef          	jal	ra,ffffffffc0203c08 <swapfs_read>
...
ffffffffc0203304:	7a068693          	addi	a3,a3,1952 # ffffffffc0205aa0 <default_pmm_manager+0xa98>
...
ffffffffc0203318:	72c50513          	addi	a0,a0,1836 # ffffffffc0205a40 <default_pmm_manager+0xa38>
{
...
ffffffffc0203326:	f406                	sd	ra,40(sp)
...
ffffffffc020332e:	e44e                	sd	s3,8(sp)
         assert(head != NULL);
ffffffffc0203330:	c73d                	beqz	a4,ffffffffc020339e <_clock_swap_out_victim+0x7c>
     assert(in_tick==0);
ffffffffc0203332:	e651                	bnez	a2,ffffffffc02033be <_clock_swap_out_victim+0x9c>
ffffffffc0203334:	0000e917          	auipc	s2,0xe
ffffffffc0203338:	25490913          	addi	s2,s2,596 # ffffffffc0211588 <curr_ptr>
ffffffffc020333c:	89ae                	mv	s3,a1
ffffffffc020333e:	00093403          	ld	s0,0(s2)
ffffffffc0203342:	4681                	li	a3,0
ffffffffc0203344:	a029                	j	ffffffffc020334e <_clock_swap_out_victim+0x2c>
            page->visited = 0;
ffffffffc0203346:	fe043023          	sd	zero,-32(s0)
    return listelm->next;
ffffffffc020334a:	4685                	li	a3,1
{
ffffffffc020334c:	8426                	mv	s0,s1
        if(curr_ptr == head) {
ffffffffc020334e:	6404                	ld	s1,8(s0)
ffffffffc0203350:	fe870de3          	beq	a4,s0,ffffffffc020334a <_clock_swap_out_victim+0x28>
        if(page->visited == 0) {
ffffffffc0203354:	fe043783          	ld	a5,-32(s0)
ffffffffc0203358:	f7fd                	bnez	a5,ffffffffc0203346 <_clock_swap_out_victim+0x24>
ffffffffc020335a:	c689                	beqz	a3,ffffffffc0203364 <_clock_swap_out_victim+0x42>
ffffffffc020335c:	0000e797          	auipc	a5,0xe
ffffffffc0203360:	2287b623          	sd	s0,556(a5) # ffffffffc0211588 <curr_ptr>
            cprintf("curr_ptr 0xffffffff%x\n",curr_ptr);
ffffffffc0203364:	85a2                	mv	a1,s0
ffffffffc0203366:	00002517          	auipc	a0,0x2
ffffffffc020336a:	78250513          	addi	a0,a0,1922 # ffffffffc0205ae8 <default_pmm_manager+0xae0>
ffffffffc020336e:	d51fc0ef          	jal	ra,ffffffffc02000be <cprintf>
            list_del(curr_ptr);
ffffffffc0203372:	00093783          	ld	a5,0(s2)
...
ffffffffc020337e:	679c                	ld	a5,8(a5)
ffffffffc0203380:	6942                	ld	s2,16(sp)
ffffffffc0203382:	4501                	li	a0,0
    prev->next = next;
ffffffffc0203384:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203386:	e398                	sd	a4,0(a5)
            *ptr_page = page;
ffffffffc0203388:	0089b023          	sd	s0,0(s3)
}
ffffffffc020338c:	7402                	ld	s0,32(sp)
            curr_ptr = next_entry;
ffffffffc020338e:	0000e797          	auipc	a5,0xe
ffffffffc0203392:	1e97bd23          	sd	s1,506(a5) # ffffffffc0211588 <curr_ptr>
}
ffffffffc0203396:	69a2                	ld	s3,8(sp)
ffffffffc0203398:	64e2                	ld	s1,24(sp)
ffffffffc020339a:	6145                	addi	sp,sp,48
ffffffffc020339c:	8082                	ret
         assert(head != NULL);
ffffffffc020339e:	00002697          	auipc	a3,0x2
ffffffffc02033a2:	72a68693          	addi	a3,a3,1834 # ffffffffc0205ac8 <default_pmm_manager+0xac0>
ffffffffc02033a6:	00002617          	auipc	a2,0x2
ffffffffc02033aa:	8ca60613          	addi	a2,a2,-1846 # ffffffffc0204c70 <commands+0x870>
ffffffffc02033ae:	04900593          	li	a1,73
ffffffffc02033b2:	00002517          	auipc	a0,0x2
ffffffffc02033b6:	68e50513          	addi	a0,a0,1678 # ffffffffc0205a40 <default_pmm_manager+0xa38>
ffffffffc02033ba:	fbbfc0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(in_tick==0);
ffffffffc02033be:	00002697          	auipc	a3,0x2
ffffffffc02033c2:	71a68693          	addi	a3,a3,1818 # ffffffffc0205ad8 <default_pmm_manager+0xad0>
ffffffffc02033c6:	00002617          	auipc	a2,0x2
ffffffffc02033ca:	8aa60613          	addi	a2,a2,-1878 # ffffffffc0204c70 <commands+0x870>
ffffffffc02033ce:	04a00593          	li	a1,74
ffffffffc02033d2:	00002517          	auipc	a0,0x2
ffffffffc02033d6:	66e50513          	addi	a0,a0,1646 # ffffffffc0205a40 <default_pmm_manager+0xa38>
ffffffffc02033da:	f9bfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02033de <check_vma_overlap.isra.0.part.1>:
}
...
ffffffffc02033e4:	73868693          	addi	a3,a3,1848 # ffffffffc0205b18 <default_pmm_manager+0xb10>
ffffffffc02033e8:	00002617          	auipc	a2,0x2
ffffffffc02033ec:	88860613          	addi	a2,a2,-1912 # ffffffffc0204c70 <commands+0x870>
ffffffffc02033f0:	07d00593          	li	a1,125
ffffffffc02033f4:	00002517          	auipc	a0,0x2
ffffffffc02033f8:	74450513          	addi	a0,a0,1860 # ffffffffc0205b38 <default_pmm_manager+0xb30>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc02033fc:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc02033fe:	f77fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203402 <mm_create>:
mm_create(void) {
ffffffffc0203402:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203404:	03000513          	li	a0,48
mm_create(void) {
ffffffffc0203408:	e022                	sd	s0,0(sp)
ffffffffc020340a:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc020340c:	a7eff0ef          	jal	ra,ffffffffc020268a <kmalloc>
ffffffffc0203410:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203412:	c115                	beqz	a0,ffffffffc0203436 <mm_create+0x34>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203414:	0000e797          	auipc	a5,0xe
ffffffffc0203418:	05478793          	addi	a5,a5,84 # ffffffffc0211468 <swap_init_ok>
ffffffffc020341c:	439c                	lw	a5,0(a5)
    elm->prev = elm->next = elm;
ffffffffc020341e:	e408                	sd	a0,8(s0)
ffffffffc0203420:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc0203422:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203426:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc020342a:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020342e:	2781                	sext.w	a5,a5
ffffffffc0203430:	eb81                	bnez	a5,ffffffffc0203440 <mm_create+0x3e>
        else mm->sm_priv = NULL;
ffffffffc0203432:	02053423          	sd	zero,40(a0)
}
ffffffffc0203436:	8522                	mv	a0,s0
ffffffffc0203438:	60a2                	ld	ra,8(sp)
ffffffffc020343a:	6402                	ld	s0,0(sp)
ffffffffc020343c:	0141                	addi	sp,sp,16
ffffffffc020343e:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203440:	a6dff0ef          	jal	ra,ffffffffc0202eac <swap_init_mm>
}
...
ffffffffc020344e <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc020344e:	1101                	addi	sp,sp,-32
ffffffffc0203450:	e04a                	sd	s2,0(sp)
ffffffffc0203452:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203454:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc0203458:	e822                	sd	s0,16(sp)
ffffffffc020345a:	e426                	sd	s1,8(sp)
ffffffffc020345c:	ec06                	sd	ra,24(sp)
ffffffffc020345e:	84ae                	mv	s1,a1
ffffffffc0203460:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203462:	a28ff0ef          	jal	ra,ffffffffc020268a <kmalloc>
    if (vma != NULL) {
ffffffffc0203466:	c509                	beqz	a0,ffffffffc0203470 <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc0203468:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc020346c:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc020346e:	ed00                	sd	s0,24(a0)
}
ffffffffc0203470:	60e2                	ld	ra,24(sp)
ffffffffc0203472:	6442                	ld	s0,16(sp)
ffffffffc0203474:	64a2                	ld	s1,8(sp)
ffffffffc0203476:	6902                	ld	s2,0(sp)
ffffffffc0203478:	6105                	addi	sp,sp,32
ffffffffc020347a:	8082                	ret

ffffffffc020347c <find_vma>:
    if (mm != NULL) {
ffffffffc020347c:	c51d                	beqz	a0,ffffffffc02034aa <find_vma+0x2e>
        vma = mm->mmap_cache;
ffffffffc020347e:	691c                	ld	a5,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203480:	c781                	beqz	a5,ffffffffc0203488 <find_vma+0xc>
ffffffffc0203482:	6798                	ld	a4,8(a5)
ffffffffc0203484:	02e5f663          	bleu	a4,a1,ffffffffc02034b0 <find_vma+0x34>
                list_entry_t *list = &(mm->mmap_list), *le = list;
ffffffffc0203488:	87aa                	mv	a5,a0
    return listelm->next;
ffffffffc020348a:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc020348c:	00f50f63          	beq	a0,a5,ffffffffc02034aa <find_vma+0x2e>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc0203490:	fe87b703          	ld	a4,-24(a5)
ffffffffc0203494:	fee5ebe3          	bltu	a1,a4,ffffffffc020348a <find_vma+0xe>
ffffffffc0203498:	ff07b703          	ld	a4,-16(a5)
ffffffffc020349c:	fee5f7e3          	bleu	a4,a1,ffffffffc020348a <find_vma+0xe>
                    vma = le2vma(le, list_link);
ffffffffc02034a0:	1781                	addi	a5,a5,-32
        if (vma != NULL) {
ffffffffc02034a2:	c781                	beqz	a5,ffffffffc02034aa <find_vma+0x2e>
            mm->mmap_cache = vma;
...
ffffffffc02034aa:	4781                	li	a5,0
}
ffffffffc02034ac:	853e                	mv	a0,a5
ffffffffc02034ae:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc02034b0:	6b98                	ld	a4,16(a5)
ffffffffc02034b2:	fce5fbe3          	bleu	a4,a1,ffffffffc0203488 <find_vma+0xc>
            mm->mmap_cache = vma;
ffffffffc02034b6:	e91c                	sd	a5,16(a0)
    return vma;
ffffffffc02034b8:	b7fd                	j	ffffffffc02034a6 <find_vma+0x2a>

ffffffffc02034ba <insert_vma_struct>:
...
ffffffffc02034ba:	6590                	ld	a2,8(a1)
ffffffffc02034bc:	0105b803          	ld	a6,16(a1) # 1010 <BASE_ADDRESS-0xffffffffc01feff0>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc02034c0:	1141                	addi	sp,sp,-16
ffffffffc02034c2:	e406                	sd	ra,8(sp)
ffffffffc02034c4:	872a                	mv	a4,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc02034c6:	01066863          	bltu	a2,a6,ffffffffc02034d6 <insert_vma_struct+0x1c>
ffffffffc02034ca:	a8b9                	j	ffffffffc0203528 <insert_vma_struct+0x6e>
...
ffffffffc02034cc:	fe87b683          	ld	a3,-24(a5)
ffffffffc02034d0:	04d66763          	bltu	a2,a3,ffffffffc020351e <insert_vma_struct+0x64>
ffffffffc02034d4:	873e                	mv	a4,a5
ffffffffc02034d6:	671c                	ld	a5,8(a4)
        while ((le = list_next(le)) != list) {
ffffffffc02034d8:	fef51ae3          	bne	a0,a5,ffffffffc02034cc <insert_vma_struct+0x12>
        }
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc02034dc:	02a70463          	beq	a4,a0,ffffffffc0203504 <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc02034e0:	ff073683          	ld	a3,-16(a4)
    assert(prev->vm_start < prev->vm_end);
ffffffffc02034e4:	fe873883          	ld	a7,-24(a4)
ffffffffc02034e8:	08d8f063          	bleu	a3,a7,ffffffffc0203568 <insert_vma_struct+0xae>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02034ec:	04d66e63          	bltu	a2,a3,ffffffffc0203548 <insert_vma_struct+0x8e>
    }
    if (le_next != list) {
ffffffffc02034f0:	00f50a63          	beq	a0,a5,ffffffffc0203504 <insert_vma_struct+0x4a>
ffffffffc02034f4:	fe87b683          	ld	a3,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc02034f8:	0506e863          	bltu	a3,a6,ffffffffc0203548 <insert_vma_struct+0x8e>
    assert(next->vm_start < next->vm_end);
ffffffffc02034fc:	ff07b603          	ld	a2,-16(a5)
ffffffffc0203500:	02c6f263          	bleu	a2,a3,ffffffffc0203524 <insert_vma_struct+0x6a>
    }
    ...
    mm->map_count ++;
ffffffffc0203504:	5114                	lw	a3,32(a0)
    vma->vm_mm = mm;
ffffffffc0203506:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc0203508:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc020350c:	e390                	sd	a2,0(a5)
ffffffffc020350e:	e710                	sd	a2,8(a4)
}
ffffffffc0203510:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc0203512:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc0203514:	f198                	sd	a4,32(a1)
    mm->map_count ++;
ffffffffc0203516:	2685                	addiw	a3,a3,1
ffffffffc0203518:	d114                	sw	a3,32(a0)
}
ffffffffc020351a:	0141                	addi	sp,sp,16
ffffffffc020351c:	8082                	ret
    if (le_prev != list) {
ffffffffc020351e:	fca711e3          	bne	a4,a0,ffffffffc02034e0 <insert_vma_struct+0x26>
ffffffffc0203522:	bfd9                	j	ffffffffc02034f8 <insert_vma_struct+0x3e>
ffffffffc0203524:	ebbff0ef          	jal	ra,ffffffffc02033de <check_vma_overlap.isra.0.part.1>
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203528:	00002697          	auipc	a3,0x2
ffffffffc020352c:	6a068693          	addi	a3,a3,1696 # ffffffffc0205bc8 <default_pmm_manager+0xbc0>
ffffffffc0203530:	00001617          	auipc	a2,0x1
ffffffffc0203534:	74060613          	addi	a2,a2,1856 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203538:	08400593          	li	a1,132
ffffffffc020353c:	00002517          	auipc	a0,0x2
ffffffffc0203540:	5fc50513          	addi	a0,a0,1532 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203544:	e31fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203548:	00002697          	auipc	a3,0x2
ffffffffc020354c:	6c068693          	addi	a3,a3,1728 # ffffffffc0205c08 <default_pmm_manager+0xc00>
ffffffffc0203550:	00001617          	auipc	a2,0x1
ffffffffc0203554:	72060613          	addi	a2,a2,1824 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203558:	07c00593          	li	a1,124
ffffffffc020355c:	00002517          	auipc	a0,0x2
ffffffffc0203560:	5dc50513          	addi	a0,a0,1500 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203564:	e11fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203568:	00002697          	auipc	a3,0x2
ffffffffc020356c:	68068693          	addi	a3,a3,1664 # ffffffffc0205be8 <default_pmm_manager+0xbe0>
ffffffffc0203570:	00001617          	auipc	a2,0x1
ffffffffc0203574:	70060613          	addi	a2,a2,1792 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203578:	07b00593          	li	a1,123
ffffffffc020357c:	00002517          	auipc	a0,0x2
ffffffffc0203580:	5bc50513          	addi	a0,a0,1468 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203584:	df1fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203588 <mm_destroy>:

// mm_destroy - free mm and mm internal fields
void
mm_destroy(struct mm_struct *mm) {
ffffffffc0203588:	1141                	addi	sp,sp,-16
ffffffffc020358a:	e022                	sd	s0,0(sp)
ffffffffc020358c:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc020358e:	6508                	ld	a0,8(a0)
ffffffffc0203590:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc0203592:	00a40e63          	beq	s0,a0,ffffffffc02035ae <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203596:	6118                	ld	a4,0(a0)
ffffffffc0203598:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc020359a:	03000593          	li	a1,48
ffffffffc020359e:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc02035a0:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02035a2:	e398                	sd	a4,0(a5)
ffffffffc02035a4:	9a8ff0ef          	jal	ra,ffffffffc020274c <kfree>
    return listelm->next;
ffffffffc02035a8:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc02035aa:	fea416e3          	bne	s0,a0,ffffffffc0203596 <mm_destroy+0xe>
    }
...
ffffffffc02035b2:	60a2                	ld	ra,8(sp)
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02035b4:	03000593          	li	a1,48
}
ffffffffc02035b8:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02035ba:	992ff06f          	j	ffffffffc020274c <kfree>

ffffffffc02035be <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc02035be:	715d                	addi	sp,sp,-80
ffffffffc02035c0:	e486                	sd	ra,72(sp)
ffffffffc02035c2:	e0a2                	sd	s0,64(sp)
ffffffffc02035c4:	fc26                	sd	s1,56(sp)
ffffffffc02035c6:	f84a                	sd	s2,48(sp)
ffffffffc02035c8:	f052                	sd	s4,32(sp)
ffffffffc02035ca:	f44e                	sd	s3,40(sp)
ffffffffc02035cc:	ec56                	sd	s5,24(sp)
ffffffffc02035ce:	e85a                	sd	s6,16(sp)
ffffffffc02035d0:	e45e                	sd	s7,8(sp)
}
...
ffffffffc02035dc:	8a2a                	mv	s4,a0

    struct mm_struct *mm = mm_create();
ffffffffc02035de:	e25ff0ef          	jal	ra,ffffffffc0203402 <mm_create>
    assert(mm != NULL);
ffffffffc02035e2:	842a                	mv	s0,a0
ffffffffc02035e4:	03200493          	li	s1,50
ffffffffc02035e8:	e919                	bnez	a0,ffffffffc02035fe <vmm_init+0x40>
ffffffffc02035ea:	aeed                	j	ffffffffc02039e4 <vmm_init+0x426>
        vma->vm_start = vm_start;
ffffffffc02035ec:	e504                	sd	s1,8(a0)
        vma->vm_end = vm_end;
ffffffffc02035ee:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02035f0:	00053c23          	sd	zero,24(a0)
    ...
    for (i = step1; i >= 1; i --) {
        ...
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02035f4:	14ed                	addi	s1,s1,-5
ffffffffc02035f6:	8522                	mv	a0,s0
ffffffffc02035f8:	ec3ff0ef          	jal	ra,ffffffffc02034ba <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc02035fc:	c88d                	beqz	s1,ffffffffc020362e <vmm_init+0x70>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02035fe:	03000513          	li	a0,48
ffffffffc0203602:	888ff0ef          	jal	ra,ffffffffc020268a <kmalloc>
ffffffffc0203606:	85aa                	mv	a1,a0
ffffffffc0203608:	00248793          	addi	a5,s1,2
    if (vma != NULL) {
ffffffffc020360c:	f165                	bnez	a0,ffffffffc02035ec <vmm_init+0x2e>
        assert(vma != NULL);
ffffffffc020360e:	00002697          	auipc	a3,0x2
ffffffffc0203612:	19268693          	addi	a3,a3,402 # ffffffffc02057a0 <default_pmm_manager+0x798>
ffffffffc0203616:	00001617          	auipc	a2,0x1
ffffffffc020361a:	65a60613          	addi	a2,a2,1626 # ffffffffc0204c70 <commands+0x870>
ffffffffc020361e:	0ce00593          	li	a1,206
ffffffffc0203622:	00002517          	auipc	a0,0x2
ffffffffc0203626:	51650513          	addi	a0,a0,1302 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc020362a:	d4bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i = step1; i >= 1; i --) {
ffffffffc020362e:	03700493          	li	s1,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203632:	1f900993          	li	s3,505
ffffffffc0203636:	a819                	j	ffffffffc020364c <vmm_init+0x8e>
        vma->vm_start = vm_start;
ffffffffc0203638:	e504                	sd	s1,8(a0)
        vma->vm_end = vm_end;
...
ffffffffc020363c:	00053c23          	sd	zero,24(a0)
        ...
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203640:	0495                	addi	s1,s1,5
ffffffffc0203642:	8522                	mv	a0,s0
ffffffffc0203644:	e77ff0ef          	jal	ra,ffffffffc02034ba <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203648:	03348a63          	beq	s1,s3,ffffffffc020367c <vmm_init+0xbe>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020364c:	03000513          	li	a0,48
ffffffffc0203650:	83aff0ef          	jal	ra,ffffffffc020268a <kmalloc>
ffffffffc0203654:	85aa                	mv	a1,a0
ffffffffc0203656:	00248793          	addi	a5,s1,2
    if (vma != NULL) {
ffffffffc020365a:	fd79                	bnez	a0,ffffffffc0203638 <vmm_init+0x7a>
        assert(vma != NULL);
ffffffffc020365c:	00002697          	auipc	a3,0x2
ffffffffc0203660:	14468693          	addi	a3,a3,324 # ffffffffc02057a0 <default_pmm_manager+0x798>
ffffffffc0203664:	00001617          	auipc	a2,0x1
ffffffffc0203668:	60c60613          	addi	a2,a2,1548 # ffffffffc0204c70 <commands+0x870>
ffffffffc020366c:	0d400593          	li	a1,212
ffffffffc0203670:	00002517          	auipc	a0,0x2
ffffffffc0203674:	4c850513          	addi	a0,a0,1224 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203678:	cfdfc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc020367c:	6418                	ld	a4,8(s0)
ffffffffc020367e:	479d                	li	a5,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc0203680:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc0203684:	2ae40063          	beq	s0,a4,ffffffffc0203924 <vmm_init+0x366>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203688:	fe873603          	ld	a2,-24(a4)
ffffffffc020368c:	ffe78693          	addi	a3,a5,-2
ffffffffc0203690:	20d61a63          	bne	a2,a3,ffffffffc02038a4 <vmm_init+0x2e6>
ffffffffc0203694:	ff073683          	ld	a3,-16(a4)
ffffffffc0203698:	20d79663          	bne	a5,a3,ffffffffc02038a4 <vmm_init+0x2e6>
ffffffffc020369c:	0795                	addi	a5,a5,5
ffffffffc020369e:	6718                	ld	a4,8(a4)
    for (i = 1; i <= step2; i ++) {
ffffffffc02036a0:	feb792e3          	bne	a5,a1,ffffffffc0203684 <vmm_init+0xc6>
ffffffffc02036a4:	499d                	li	s3,7
ffffffffc02036a6:	4495                	li	s1,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc02036a8:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc02036ac:	85a6                	mv	a1,s1
ffffffffc02036ae:	8522                	mv	a0,s0
ffffffffc02036b0:	dcdff0ef          	jal	ra,ffffffffc020347c <find_vma>
ffffffffc02036b4:	8b2a                	mv	s6,a0
        assert(vma1 != NULL);
ffffffffc02036b6:	2e050763          	beqz	a0,ffffffffc02039a4 <vmm_init+0x3e6>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc02036ba:	00148593          	addi	a1,s1,1
ffffffffc02036be:	8522                	mv	a0,s0
ffffffffc02036c0:	dbdff0ef          	jal	ra,ffffffffc020347c <find_vma>
ffffffffc02036c4:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc02036c6:	2a050f63          	beqz	a0,ffffffffc0203984 <vmm_init+0x3c6>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc02036ca:	85ce                	mv	a1,s3
ffffffffc02036cc:	8522                	mv	a0,s0
ffffffffc02036ce:	dafff0ef          	jal	ra,ffffffffc020347c <find_vma>
        assert(vma3 == NULL);
ffffffffc02036d2:	28051963          	bnez	a0,ffffffffc0203964 <vmm_init+0x3a6>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc02036d6:	00348593          	addi	a1,s1,3
ffffffffc02036da:	8522                	mv	a0,s0
ffffffffc02036dc:	da1ff0ef          	jal	ra,ffffffffc020347c <find_vma>
        assert(vma4 == NULL);
ffffffffc02036e0:	26051263          	bnez	a0,ffffffffc0203944 <vmm_init+0x386>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc02036e4:	00448593          	addi	a1,s1,4
ffffffffc02036e8:	8522                	mv	a0,s0
ffffffffc02036ea:	d93ff0ef          	jal	ra,ffffffffc020347c <find_vma>
        assert(vma5 == NULL);
ffffffffc02036ee:	2c051b63          	bnez	a0,ffffffffc02039c4 <vmm_init+0x406>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02036f2:	008b3783          	ld	a5,8(s6)
ffffffffc02036f6:	1c979763          	bne	a5,s1,ffffffffc02038c4 <vmm_init+0x306>
ffffffffc02036fa:	010b3783          	ld	a5,16(s6)
ffffffffc02036fe:	1d379363          	bne	a5,s3,ffffffffc02038c4 <vmm_init+0x306>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203702:	008ab783          	ld	a5,8(s5)
ffffffffc0203706:	1c979f63          	bne	a5,s1,ffffffffc02038e4 <vmm_init+0x326>
ffffffffc020370a:	010ab783          	ld	a5,16(s5)
ffffffffc020370e:	1d379b63          	bne	a5,s3,ffffffffc02038e4 <vmm_init+0x326>
ffffffffc0203712:	0495                	addi	s1,s1,5
ffffffffc0203714:	0995                	addi	s3,s3,5
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203716:	f9749be3          	bne	s1,s7,ffffffffc02036ac <vmm_init+0xee>
ffffffffc020371a:	4491                	li	s1,4
    }

    for (i =4; i>=0; i--) {
ffffffffc020371c:	59fd                	li	s3,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc020371e:	85a6                	mv	a1,s1
ffffffffc0203720:	8522                	mv	a0,s0
ffffffffc0203722:	d5bff0ef          	jal	ra,ffffffffc020347c <find_vma>
ffffffffc0203726:	0004859b          	sext.w	a1,s1
        if (vma_below_5 != NULL ) {
ffffffffc020372a:	c90d                	beqz	a0,ffffffffc020375c <vmm_init+0x19e>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc020372c:	6914                	ld	a3,16(a0)
ffffffffc020372e:	6510                	ld	a2,8(a0)
ffffffffc0203730:	00002517          	auipc	a0,0x2
ffffffffc0203734:	5f850513          	addi	a0,a0,1528 # ffffffffc0205d28 <default_pmm_manager+0xd20>
ffffffffc0203738:	987fc0ef          	jal	ra,ffffffffc02000be <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc020373c:	00002697          	auipc	a3,0x2
ffffffffc0203740:	61468693          	addi	a3,a3,1556 # ffffffffc0205d50 <default_pmm_manager+0xd48>
ffffffffc0203744:	00001617          	auipc	a2,0x1
ffffffffc0203748:	52c60613          	addi	a2,a2,1324 # ffffffffc0204c70 <commands+0x870>
ffffffffc020374c:	0f600593          	li	a1,246
ffffffffc0203750:	00002517          	auipc	a0,0x2
ffffffffc0203754:	3e850513          	addi	a0,a0,1000 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203758:	c1dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc020375c:	14fd                	addi	s1,s1,-1
    for (i =4; i>=0; i--) {
ffffffffc020375e:	fd3490e3          	bne	s1,s3,ffffffffc020371e <vmm_init+0x160>
    }

    mm_destroy(mm);
ffffffffc0203762:	8522                	mv	a0,s0
ffffffffc0203764:	e25ff0ef          	jal	ra,ffffffffc0203588 <mm_destroy>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203768:	fc5fd0ef          	jal	ra,ffffffffc020172c <nr_free_pages>
ffffffffc020376c:	28aa1c63          	bne	s4,a0,ffffffffc0203a04 <vmm_init+0x446>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc0203770:	00002517          	auipc	a0,0x2
ffffffffc0203774:	62050513          	addi	a0,a0,1568 # ffffffffc0205d90 <default_pmm_manager+0xd88>
ffffffffc0203778:	947fc0ef          	jal	ra,ffffffffc02000be <cprintf>
...
check_pgfault(void) {
    ...
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc020377c:	fb1fd0ef          	jal	ra,ffffffffc020172c <nr_free_pages>
ffffffffc0203780:	89aa                	mv	s3,a0

    check_mm_struct = mm_create();
ffffffffc0203782:	c81ff0ef          	jal	ra,ffffffffc0203402 <mm_create>
ffffffffc0203786:	0000e797          	auipc	a5,0xe
ffffffffc020378a:	e0a7b523          	sd	a0,-502(a5) # ffffffffc0211590 <check_mm_struct>
ffffffffc020378e:	842a                	mv	s0,a0

    assert(check_mm_struct != NULL);
ffffffffc0203790:	2a050a63          	beqz	a0,ffffffffc0203a44 <vmm_init+0x486>
    struct mm_struct *mm = check_mm_struct;
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203794:	0000e797          	auipc	a5,0xe
ffffffffc0203798:	cbc78793          	addi	a5,a5,-836 # ffffffffc0211450 <boot_pgdir>
ffffffffc020379c:	6384                	ld	s1,0(a5)
    assert(pgdir[0] == 0);
ffffffffc020379e:	609c                	ld	a5,0(s1)
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02037a0:	ed04                	sd	s1,24(a0)
    assert(pgdir[0] == 0);
ffffffffc02037a2:	32079d63          	bnez	a5,ffffffffc0203adc <vmm_init+0x51e>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02037a6:	03000513          	li	a0,48
ffffffffc02037aa:	ee1fe0ef          	jal	ra,ffffffffc020268a <kmalloc>
ffffffffc02037ae:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc02037b0:	14050a63          	beqz	a0,ffffffffc0203904 <vmm_init+0x346>
        vma->vm_end = vm_end;
ffffffffc02037b4:	002007b7          	lui	a5,0x200
ffffffffc02037b8:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc02037bc:	4789                	li	a5,2
    ...
    insert_vma_struct(mm, vma);
ffffffffc02037be:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc02037c0:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc02037c4:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc02037c6:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc02037ca:	cf1ff0ef          	jal	ra,ffffffffc02034ba <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc02037ce:	10000593          	li	a1,256
ffffffffc02037d2:	8522                	mv	a0,s0
ffffffffc02037d4:	ca9ff0ef          	jal	ra,ffffffffc020347c <find_vma>
ffffffffc02037d8:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc02037dc:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc02037e0:	2aaa1263          	bne	s4,a0,ffffffffc0203a84 <vmm_init+0x4c6>
        *(char *)(addr + i) = i;
ffffffffc02037e4:	00f78023          	sb	a5,0(a5) # 200000 <BASE_ADDRESS-0xffffffffc0000000>
        sum += i;
ffffffffc02037e8:	0785                	addi	a5,a5,1
    for (i = 0; i < 100; i ++) {
ffffffffc02037ea:	fee79de3          	bne	a5,a4,ffffffffc02037e4 <vmm_init+0x226>
        sum += i;
ffffffffc02037ee:	6705                	lui	a4,0x1
    for (i = 0; i < 100; i ++) {
ffffffffc02037f0:	10000793          	li	a5,256
        sum += i;
ffffffffc02037f4:	35670713          	addi	a4,a4,854 # 1356 <BASE_ADDRESS-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc02037f8:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc02037fc:	0007c683          	lbu	a3,0(a5)
ffffffffc0203800:	0785                	addi	a5,a5,1
ffffffffc0203802:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc0203804:	fec79ce3          	bne	a5,a2,ffffffffc02037fc <vmm_init+0x23e>
    }
    assert(sum == 0);
ffffffffc0203808:	2a071a63          	bnez	a4,ffffffffc0203abc <vmm_init+0x4fe>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc020380c:	4581                	li	a1,0
ffffffffc020380e:	8526                	mv	a0,s1
ffffffffc0203810:	9c2fe0ef          	jal	ra,ffffffffc02019d2 <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203814:	609c                	ld	a5,0(s1)
    if (PPN(pa) >= npage) {
ffffffffc0203816:	0000e717          	auipc	a4,0xe
ffffffffc020381a:	c4270713          	addi	a4,a4,-958 # ffffffffc0211458 <npage>
ffffffffc020381e:	6318                	ld	a4,0(a4)
    return pa2page(PDE_ADDR(pde));
ffffffffc0203820:	078a                	slli	a5,a5,0x2
ffffffffc0203822:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203824:	28e7f063          	bleu	a4,a5,ffffffffc0203aa4 <vmm_init+0x4e6>
    return &pages[PPN(pa) - nbase];
ffffffffc0203828:	00003717          	auipc	a4,0x3
ffffffffc020382c:	8a870713          	addi	a4,a4,-1880 # ffffffffc02060d0 <nbase>
ffffffffc0203830:	6318                	ld	a4,0(a4)
ffffffffc0203832:	0000e697          	auipc	a3,0xe
ffffffffc0203836:	c7668693          	addi	a3,a3,-906 # ffffffffc02114a8 <pages>
ffffffffc020383a:	6288                	ld	a0,0(a3)
ffffffffc020383c:	8f99                	sub	a5,a5,a4
ffffffffc020383e:	00379713          	slli	a4,a5,0x3
ffffffffc0203842:	97ba                	add	a5,a5,a4
ffffffffc0203844:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc0203846:	953e                	add	a0,a0,a5
ffffffffc0203848:	4585                	li	a1,1
ffffffffc020384a:	e9dfd0ef          	jal	ra,ffffffffc02016e6 <free_pages>

    pgdir[0] = 0;
ffffffffc020384e:	0004b023          	sd	zero,0(s1)

    mm->pgdir = NULL;
    mm_destroy(mm);
ffffffffc0203852:	8522                	mv	a0,s0
    mm->pgdir = NULL;
ffffffffc0203854:	00043c23          	sd	zero,24(s0)
    mm_destroy(mm);
ffffffffc0203858:	d31ff0ef          	jal	ra,ffffffffc0203588 <mm_destroy>

    check_mm_struct = NULL;
    nr_free_pages_store--;	// szx : Sv39第二级页表多占了一个内存页，所以执行此操作
ffffffffc020385c:	19fd                	addi	s3,s3,-1
    check_mm_struct = NULL;
ffffffffc020385e:	0000e797          	auipc	a5,0xe
ffffffffc0203862:	d207b923          	sd	zero,-718(a5) # ffffffffc0211590 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203866:	ec7fd0ef          	jal	ra,ffffffffc020172c <nr_free_pages>
ffffffffc020386a:	1aa99d63          	bne	s3,a0,ffffffffc0203a24 <vmm_init+0x466>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc020386e:	00002517          	auipc	a0,0x2
ffffffffc0203872:	58a50513          	addi	a0,a0,1418 # ffffffffc0205df8 <default_pmm_manager+0xdf0>
ffffffffc0203876:	849fc0ef          	jal	ra,ffffffffc02000be <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc020387a:	eb3fd0ef          	jal	ra,ffffffffc020172c <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc020387e:	197d                	addi	s2,s2,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203880:	1ea91263          	bne	s2,a0,ffffffffc0203a64 <vmm_init+0x4a6>
}
ffffffffc0203884:	6406                	ld	s0,64(sp)
ffffffffc0203886:	60a6                	ld	ra,72(sp)
ffffffffc0203888:	74e2                	ld	s1,56(sp)
ffffffffc020388a:	7942                	ld	s2,48(sp)
ffffffffc020388c:	79a2                	ld	s3,40(sp)
ffffffffc020388e:	7a02                	ld	s4,32(sp)
ffffffffc0203890:	6ae2                	ld	s5,24(sp)
ffffffffc0203892:	6b42                	ld	s6,16(sp)
ffffffffc0203894:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203896:	00002517          	auipc	a0,0x2
ffffffffc020389a:	58250513          	addi	a0,a0,1410 # ffffffffc0205e18 <default_pmm_manager+0xe10>
}
ffffffffc020389e:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc02038a0:	81ffc06f          	j	ffffffffc02000be <cprintf>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc02038a4:	00002697          	auipc	a3,0x2
ffffffffc02038a8:	39c68693          	addi	a3,a3,924 # ffffffffc0205c40 <default_pmm_manager+0xc38>
ffffffffc02038ac:	00001617          	auipc	a2,0x1
ffffffffc02038b0:	3c460613          	addi	a2,a2,964 # ffffffffc0204c70 <commands+0x870>
ffffffffc02038b4:	0dd00593          	li	a1,221
ffffffffc02038b8:	00002517          	auipc	a0,0x2
ffffffffc02038bc:	28050513          	addi	a0,a0,640 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc02038c0:	ab5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02038c4:	00002697          	auipc	a3,0x2
ffffffffc02038c8:	40468693          	addi	a3,a3,1028 # ffffffffc0205cc8 <default_pmm_manager+0xcc0>
ffffffffc02038cc:	00001617          	auipc	a2,0x1
ffffffffc02038d0:	3a460613          	addi	a2,a2,932 # ffffffffc0204c70 <commands+0x870>
ffffffffc02038d4:	0ed00593          	li	a1,237
ffffffffc02038d8:	00002517          	auipc	a0,0x2
ffffffffc02038dc:	26050513          	addi	a0,a0,608 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc02038e0:	a95fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02038e4:	00002697          	auipc	a3,0x2
ffffffffc02038e8:	41468693          	addi	a3,a3,1044 # ffffffffc0205cf8 <default_pmm_manager+0xcf0>
ffffffffc02038ec:	00001617          	auipc	a2,0x1
ffffffffc02038f0:	38460613          	addi	a2,a2,900 # ffffffffc0204c70 <commands+0x870>
ffffffffc02038f4:	0ee00593          	li	a1,238
ffffffffc02038f8:	00002517          	auipc	a0,0x2
ffffffffc02038fc:	24050513          	addi	a0,a0,576 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203900:	a75fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203904:	00002697          	auipc	a3,0x2
ffffffffc0203908:	e9c68693          	addi	a3,a3,-356 # ffffffffc02057a0 <default_pmm_manager+0x798>
ffffffffc020390c:	00001617          	auipc	a2,0x1
ffffffffc0203910:	36460613          	addi	a2,a2,868 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203914:	11100593          	li	a1,273
ffffffffc0203918:	00002517          	auipc	a0,0x2
ffffffffc020391c:	22050513          	addi	a0,a0,544 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203920:	a55fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203924:	00002697          	auipc	a3,0x2
ffffffffc0203928:	30468693          	addi	a3,a3,772 # ffffffffc0205c28 <default_pmm_manager+0xc20>
ffffffffc020392c:	00001617          	auipc	a2,0x1
ffffffffc0203930:	34460613          	addi	a2,a2,836 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203934:	0db00593          	li	a1,219
ffffffffc0203938:	00002517          	auipc	a0,0x2
ffffffffc020393c:	20050513          	addi	a0,a0,512 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203940:	a35fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203944:	00002697          	auipc	a3,0x2
ffffffffc0203948:	36468693          	addi	a3,a3,868 # ffffffffc0205ca8 <default_pmm_manager+0xca0>
ffffffffc020394c:	00001617          	auipc	a2,0x1
ffffffffc0203950:	32460613          	addi	a2,a2,804 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203954:	0e900593          	li	a1,233
ffffffffc0203958:	00002517          	auipc	a0,0x2
ffffffffc020395c:	1e050513          	addi	a0,a0,480 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203960:	a15fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203964:	00002697          	auipc	a3,0x2
ffffffffc0203968:	33468693          	addi	a3,a3,820 # ffffffffc0205c98 <default_pmm_manager+0xc90>
ffffffffc020396c:	00001617          	auipc	a2,0x1
ffffffffc0203970:	30460613          	addi	a2,a2,772 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203974:	0e700593          	li	a1,231
ffffffffc0203978:	00002517          	auipc	a0,0x2
ffffffffc020397c:	1c050513          	addi	a0,a0,448 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203980:	9f5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203984:	00002697          	auipc	a3,0x2
ffffffffc0203988:	30468693          	addi	a3,a3,772 # ffffffffc0205c88 <default_pmm_manager+0xc80>
ffffffffc020398c:	00001617          	auipc	a2,0x1
ffffffffc0203990:	2e460613          	addi	a2,a2,740 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203994:	0e500593          	li	a1,229
ffffffffc0203998:	00002517          	auipc	a0,0x2
ffffffffc020399c:	1a050513          	addi	a0,a0,416 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc02039a0:	9d5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc02039a4:	00002697          	auipc	a3,0x2
ffffffffc02039a8:	2d468693          	addi	a3,a3,724 # ffffffffc0205c78 <default_pmm_manager+0xc70>
ffffffffc02039ac:	00001617          	auipc	a2,0x1
ffffffffc02039b0:	2c460613          	addi	a2,a2,708 # ffffffffc0204c70 <commands+0x870>
ffffffffc02039b4:	0e300593          	li	a1,227
ffffffffc02039b8:	00002517          	auipc	a0,0x2
ffffffffc02039bc:	18050513          	addi	a0,a0,384 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc02039c0:	9b5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc02039c4:	00002697          	auipc	a3,0x2
ffffffffc02039c8:	2f468693          	addi	a3,a3,756 # ffffffffc0205cb8 <default_pmm_manager+0xcb0>
ffffffffc02039cc:	00001617          	auipc	a2,0x1
ffffffffc02039d0:	2a460613          	addi	a2,a2,676 # ffffffffc0204c70 <commands+0x870>
ffffffffc02039d4:	0eb00593          	li	a1,235
ffffffffc02039d8:	00002517          	auipc	a0,0x2
ffffffffc02039dc:	16050513          	addi	a0,a0,352 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc02039e0:	995fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc02039e4:	00002697          	auipc	a3,0x2
ffffffffc02039e8:	d8468693          	addi	a3,a3,-636 # ffffffffc0205768 <default_pmm_manager+0x760>
ffffffffc02039ec:	00001617          	auipc	a2,0x1
ffffffffc02039f0:	28460613          	addi	a2,a2,644 # ffffffffc0204c70 <commands+0x870>
ffffffffc02039f4:	0c700593          	li	a1,199
ffffffffc02039f8:	00002517          	auipc	a0,0x2
ffffffffc02039fc:	14050513          	addi	a0,a0,320 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203a00:	975fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a04:	00002697          	auipc	a3,0x2
ffffffffc0203a08:	36468693          	addi	a3,a3,868 # ffffffffc0205d68 <default_pmm_manager+0xd60>
ffffffffc0203a0c:	00001617          	auipc	a2,0x1
ffffffffc0203a10:	26460613          	addi	a2,a2,612 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203a14:	0fb00593          	li	a1,251
ffffffffc0203a18:	00002517          	auipc	a0,0x2
ffffffffc0203a1c:	12050513          	addi	a0,a0,288 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203a20:	955fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a24:	00002697          	auipc	a3,0x2
ffffffffc0203a28:	34468693          	addi	a3,a3,836 # ffffffffc0205d68 <default_pmm_manager+0xd60>
ffffffffc0203a2c:	00001617          	auipc	a2,0x1
ffffffffc0203a30:	24460613          	addi	a2,a2,580 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203a34:	12e00593          	li	a1,302
ffffffffc0203a38:	00002517          	auipc	a0,0x2
ffffffffc0203a3c:	10050513          	addi	a0,a0,256 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203a40:	935fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203a44:	00002697          	auipc	a3,0x2
ffffffffc0203a48:	36c68693          	addi	a3,a3,876 # ffffffffc0205db0 <default_pmm_manager+0xda8>
ffffffffc0203a4c:	00001617          	auipc	a2,0x1
ffffffffc0203a50:	22460613          	addi	a2,a2,548 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203a54:	10a00593          	li	a1,266
ffffffffc0203a58:	00002517          	auipc	a0,0x2
ffffffffc0203a5c:	0e050513          	addi	a0,a0,224 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203a60:	915fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a64:	00002697          	auipc	a3,0x2
ffffffffc0203a68:	30468693          	addi	a3,a3,772 # ffffffffc0205d68 <default_pmm_manager+0xd60>
ffffffffc0203a6c:	00001617          	auipc	a2,0x1
ffffffffc0203a70:	20460613          	addi	a2,a2,516 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203a74:	0bd00593          	li	a1,189
ffffffffc0203a78:	00002517          	auipc	a0,0x2
ffffffffc0203a7c:	0c050513          	addi	a0,a0,192 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203a80:	8f5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203a84:	00002697          	auipc	a3,0x2
ffffffffc0203a88:	34468693          	addi	a3,a3,836 # ffffffffc0205dc8 <default_pmm_manager+0xdc0>
ffffffffc0203a8c:	00001617          	auipc	a2,0x1
ffffffffc0203a90:	1e460613          	addi	a2,a2,484 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203a94:	11600593          	li	a1,278
ffffffffc0203a98:	00002517          	auipc	a0,0x2
ffffffffc0203a9c:	0a050513          	addi	a0,a0,160 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203aa0:	8d5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203aa4:	00001617          	auipc	a2,0x1
ffffffffc0203aa8:	62c60613          	addi	a2,a2,1580 # ffffffffc02050d0 <default_pmm_manager+0xc8>
ffffffffc0203aac:	06500593          	li	a1,101
ffffffffc0203ab0:	00001517          	auipc	a0,0x1
ffffffffc0203ab4:	64050513          	addi	a0,a0,1600 # ffffffffc02050f0 <default_pmm_manager+0xe8>
ffffffffc0203ab8:	8bdfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203abc:	00002697          	auipc	a3,0x2
ffffffffc0203ac0:	32c68693          	addi	a3,a3,812 # ffffffffc0205de8 <default_pmm_manager+0xde0>
ffffffffc0203ac4:	00001617          	auipc	a2,0x1
ffffffffc0203ac8:	1ac60613          	addi	a2,a2,428 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203acc:	12000593          	li	a1,288
ffffffffc0203ad0:	00002517          	auipc	a0,0x2
ffffffffc0203ad4:	06850513          	addi	a0,a0,104 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203ad8:	89dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203adc:	00002697          	auipc	a3,0x2
ffffffffc0203ae0:	cb468693          	addi	a3,a3,-844 # ffffffffc0205790 <default_pmm_manager+0x788>
ffffffffc0203ae4:	00001617          	auipc	a2,0x1
ffffffffc0203ae8:	18c60613          	addi	a2,a2,396 # ffffffffc0204c70 <commands+0x870>
ffffffffc0203aec:	10d00593          	li	a1,269
ffffffffc0203af0:	00002517          	auipc	a0,0x2
ffffffffc0203af4:	04850513          	addi	a0,a0,72 # ffffffffc0205b38 <default_pmm_manager+0xb30>
ffffffffc0203af8:	87dfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203afc <do_pgfault>:
...
ffffffffc0203afc:	7179                	addi	sp,sp,-48
    int ret = -E_INVAL;
    //try to find a vma which include addr
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203afe:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203b00:	f022                	sd	s0,32(sp)
ffffffffc0203b02:	ec26                	sd	s1,24(sp)
ffffffffc0203b04:	f406                	sd	ra,40(sp)
ffffffffc0203b06:	e84a                	sd	s2,16(sp)
ffffffffc0203b08:	8432                	mv	s0,a2
ffffffffc0203b0a:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203b0c:	971ff0ef          	jal	ra,ffffffffc020347c <find_vma>

    pgfault_num++;
ffffffffc0203b10:	0000e797          	auipc	a5,0xe
ffffffffc0203b14:	95c78793          	addi	a5,a5,-1700 # ffffffffc021146c <pgfault_num>
ffffffffc0203b18:	439c                	lw	a5,0(a5)
ffffffffc0203b1a:	2785                	addiw	a5,a5,1
ffffffffc0203b1c:	0000e717          	auipc	a4,0xe
ffffffffc0203b20:	94f72823          	sw	a5,-1712(a4) # ffffffffc021146c <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203b24:	c549                	beqz	a0,ffffffffc0203bae <do_pgfault+0xb2>
ffffffffc0203b26:	651c                	ld	a5,8(a0)
ffffffffc0203b28:	08f46363          	bltu	s0,a5,ffffffffc0203bae <do_pgfault+0xb2>
...
ffffffffc0203b2c:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203b2e:	4941                	li	s2,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203b30:	8b89                	andi	a5,a5,2
ffffffffc0203b32:	efa9                	bnez	a5,ffffffffc0203b8c <do_pgfault+0x90>
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203b34:	767d                	lui	a2,0xfffff
...
ffffffffc0203b36:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203b38:	8c71                	and	s0,s0,a2
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203b3a:	85a2                	mv	a1,s0
ffffffffc0203b3c:	4605                	li	a2,1
ffffffffc0203b3e:	c2ffd0ef          	jal	ra,ffffffffc020176c <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203b42:	610c                	ld	a1,0(a0)
ffffffffc0203b44:	c5b1                	beqz	a1,ffffffffc0203b90 <do_pgfault+0x94>
...
ffffffffc0203b4a:	92278793          	addi	a5,a5,-1758 # ffffffffc0211468 <swap_init_ok>
ffffffffc0203b4e:	439c                	lw	a5,0(a5)
ffffffffc0203b50:	2781                	sext.w	a5,a5
ffffffffc0203b52:	c7bd                	beqz	a5,ffffffffc0203bc0 <do_pgfault+0xc4>
...
ffffffffc0203b54:	85a2                	mv	a1,s0
ffffffffc0203b56:	0030                	addi	a2,sp,8
ffffffffc0203b58:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203b5a:	e402                	sd	zero,8(sp)
            ret = swap_in(mm, addr, &page);
ffffffffc0203b5c:	c84ff0ef          	jal	ra,ffffffffc0202fe0 <swap_in>
            page_insert(mm->pgdir,page,addr,perm);
ffffffffc0203b60:	65a2                	ld	a1,8(sp)
ffffffffc0203b62:	6c88                	ld	a0,24(s1)
ffffffffc0203b64:	86ca                	mv	a3,s2
...
ffffffffc0203b74:	b48ff0ef          	jal	ra,ffffffffc0202ebc <swap_map_swappable>
            page->pra_vaddr = addr;
ffffffffc0203b78:	6722                	ld	a4,8(sp)
   ...
   ret = 0;
ffffffffc0203b7a:	4781                	li	a5,0
            page->pra_vaddr = addr;
ffffffffc0203b7c:	e320                	sd	s0,64(a4)
failed:
    return ret;
}
ffffffffc0203b7e:	70a2                	ld	ra,40(sp)
ffffffffc0203b80:	7402                	ld	s0,32(sp)
ffffffffc0203b82:	64e2                	ld	s1,24(sp)
ffffffffc0203b84:	6942                	ld	s2,16(sp)
ffffffffc0203b86:	853e                	mv	a0,a5
ffffffffc0203b88:	6145                	addi	sp,sp,48
ffffffffc0203b8a:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203b8c:	4959                	li	s2,22
ffffffffc0203b8e:	b75d                	j	ffffffffc0203b34 <do_pgfault+0x38>
...
ffffffffc0203b96:	a63fe0ef          	jal	ra,ffffffffc02025f8 <pgdir_alloc_page>
   ret = 0;
ffffffffc0203b9a:	4781                	li	a5,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203b9c:	f16d                	bnez	a0,ffffffffc0203b7e <do_pgfault+0x82>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203b9e:	00002517          	auipc	a0,0x2
ffffffffc0203ba2:	fda50513          	addi	a0,a0,-38 # ffffffffc0205b78 <default_pmm_manager+0xb70>
ffffffffc0203ba6:	d18fc0ef          	jal	ra,ffffffffc02000be <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203baa:	57f1                	li	a5,-4
            goto failed;
ffffffffc0203bac:	bfc9                	j	ffffffffc0203b7e <do_pgfault+0x82>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203bae:	85a2                	mv	a1,s0
ffffffffc0203bb0:	00002517          	auipc	a0,0x2
ffffffffc0203bb4:	f9850513          	addi	a0,a0,-104 # ffffffffc0205b48 <default_pmm_manager+0xb40>
ffffffffc0203bb8:	d06fc0ef          	jal	ra,ffffffffc02000be <cprintf>
    int ret = -E_INVAL;
ffffffffc0203bbc:	57f5                	li	a5,-3
        goto failed;
ffffffffc0203bbe:	b7c1                	j	ffffffffc0203b7e <do_pgfault+0x82>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203bc0:	00002517          	auipc	a0,0x2
ffffffffc0203bc4:	fe050513          	addi	a0,a0,-32 # ffffffffc0205ba0 <default_pmm_manager+0xb98>
ffffffffc0203bc8:	cf6fc0ef          	jal	ra,ffffffffc02000be <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203bcc:	57f1                	li	a5,-4
            goto failed;
ffffffffc0203bce:	bf45                	j	ffffffffc0203b7e <do_pgfault+0x82>
...
ffffffffc0203c16:	92670713          	addi	a4,a4,-1754 # ffffffffc0211538 <max_swap_offset>
...
ffffffffc0203c24:	88870713          	addi	a4,a4,-1912 # ffffffffc02114a8 <pages>
ffffffffc0203c28:	6310                	ld	a2,0(a4)
ffffffffc0203c2a:	00001717          	auipc	a4,0x1
ffffffffc0203c2e:	02e70713          	addi	a4,a4,46 # ffffffffc0204c58 <commands+0x858>
ffffffffc0203c32:	00002697          	auipc	a3,0x2
ffffffffc0203c36:	49e68693          	addi	a3,a3,1182 # ffffffffc02060d0 <nbase>
...
ffffffffc0203c68:	83478793          	addi	a5,a5,-1996 # ffffffffc0211498 <va_pa_offset>
...
ffffffffc0203c76:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203c78:	833fc06f          	j	ffffffffc02004aa <ide_read_secs>
ffffffffc0203c7c:	86aa                	mv	a3,a0
ffffffffc0203c7e:	00002617          	auipc	a2,0x2
ffffffffc0203c82:	1ea60613          	addi	a2,a2,490 # ffffffffc0205e68 <default_pmm_manager+0xe60>
ffffffffc0203c86:	45d1                	li	a1,20
ffffffffc0203c88:	00002517          	auipc	a0,0x2
ffffffffc0203c8c:	1c850513          	addi	a0,a0,456 # ffffffffc0205e50 <default_pmm_manager+0xe48>
...
ffffffffc0203c9e:	3be60613          	addi	a2,a2,958 # ffffffffc0205058 <default_pmm_manager+0x50>
ffffffffc0203ca2:	00001517          	auipc	a0,0x1
ffffffffc0203ca6:	44e50513          	addi	a0,a0,1102 # ffffffffc02050f0 <default_pmm_manager+0xe8>
...
ffffffffc0203cbc:	88070713          	addi	a4,a4,-1920 # ffffffffc0211538 <max_swap_offset>
...
ffffffffc0203cca:	7e270713          	addi	a4,a4,2018 # ffffffffc02114a8 <pages>
ffffffffc0203cce:	6310                	ld	a2,0(a4)
ffffffffc0203cd0:	00001717          	auipc	a4,0x1
ffffffffc0203cd4:	f8870713          	addi	a4,a4,-120 # ffffffffc0204c58 <commands+0x858>
ffffffffc0203cd8:	00002697          	auipc	a3,0x2
ffffffffc0203cdc:	3f868693          	addi	a3,a3,1016 # ffffffffc02060d0 <nbase>
...
ffffffffc0203d0e:	78e78793          	addi	a5,a5,1934 # ffffffffc0211498 <va_pa_offset>
...
ffffffffc0203d1c:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203d1e:	fb0fc06f          	j	ffffffffc02004ce <ide_write_secs>
ffffffffc0203d22:	86aa                	mv	a3,a0
ffffffffc0203d24:	00002617          	auipc	a2,0x2
ffffffffc0203d28:	14460613          	addi	a2,a2,324 # ffffffffc0205e68 <default_pmm_manager+0xe60>
ffffffffc0203d2c:	45e5                	li	a1,25
ffffffffc0203d2e:	00002517          	auipc	a0,0x2
ffffffffc0203d32:	12250513          	addi	a0,a0,290 # ffffffffc0205e50 <default_pmm_manager+0xe48>
...
ffffffffc0203d44:	31860613          	addi	a2,a2,792 # ffffffffc0205058 <default_pmm_manager+0x50>
ffffffffc0203d48:	00001517          	auipc	a0,0x1
ffffffffc0203d4c:	3a850513          	addi	a0,a0,936 # ffffffffc02050f0 <default_pmm_manager+0xe8>
ffffffffc0203d50:	e24fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203d54 <printnum>:
 * */
static void
...
ffffffffc0203d54:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203d58:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203d5a:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203d5e:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203d60:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203d64:	f022                	sd	s0,32(sp)
ffffffffc0203d66:	ec26                	sd	s1,24(sp)
ffffffffc0203d68:	e84a                	sd	s2,16(sp)
ffffffffc0203d6a:	f406                	sd	ra,40(sp)
ffffffffc0203d6c:	e44e                	sd	s3,8(sp)
ffffffffc0203d6e:	84aa                	mv	s1,a0
ffffffffc0203d70:	892e                	mv	s2,a1
ffffffffc0203d72:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203d76:	2a01                	sext.w	s4,s4

    // first recursively print all preceding (more significant) digits
    if (num >= base) {
ffffffffc0203d78:	03067e63          	bleu	a6,a2,ffffffffc0203db4 <printnum+0x60>
ffffffffc0203d7c:	89be                	mv	s3,a5
        printnum(putch, putdat, result, base, width - 1, padc);
    } else {
        // print any needed pad characters before first digit
        while (-- width > 0)
ffffffffc0203d7e:	00805763          	blez	s0,ffffffffc0203d8c <printnum+0x38>
ffffffffc0203d82:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203d84:	85ca                	mv	a1,s2
ffffffffc0203d86:	854e                	mv	a0,s3
ffffffffc0203d88:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203d8a:	fc65                	bnez	s0,ffffffffc0203d82 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203d8c:	1a02                	slli	s4,s4,0x20
ffffffffc0203d8e:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203d92:	00002797          	auipc	a5,0x2
ffffffffc0203d96:	28678793          	addi	a5,a5,646 # ffffffffc0206018 <error_string+0x38>
ffffffffc0203d9a:	9a3e                	add	s4,s4,a5
}
ffffffffc0203d9c:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203d9e:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203da2:	70a2                	ld	ra,40(sp)
ffffffffc0203da4:	69a2                	ld	s3,8(sp)
ffffffffc0203da6:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203da8:	85ca                	mv	a1,s2
ffffffffc0203daa:	8326                	mv	t1,s1
}
ffffffffc0203dac:	6942                	ld	s2,16(sp)
ffffffffc0203dae:	64e2                	ld	s1,24(sp)
ffffffffc0203db0:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203db2:	8302                	jr	t1
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203db4:	03065633          	divu	a2,a2,a6
ffffffffc0203db8:	8722                	mv	a4,s0
ffffffffc0203dba:	f9bff0ef          	jal	ra,ffffffffc0203d54 <printnum>
ffffffffc0203dbe:	b7f9                	j	ffffffffc0203d8c <printnum+0x38>
...
ffffffffc0203dc6:	e8d2                	sd	s4,80(sp)
ffffffffc0203dc8:	e4d6                	sd	s5,72(sp)
ffffffffc0203dca:	e0da                	sd	s6,64(sp)
ffffffffc0203dcc:	fc5e                	sd	s7,56(sp)
ffffffffc0203dce:	f862                	sd	s8,48(sp)
ffffffffc0203dd0:	f06a                	sd	s10,32(sp)
ffffffffc0203dd2:	fc86                	sd	ra,120(sp)
ffffffffc0203dd4:	f8a2                	sd	s0,112(sp)
ffffffffc0203dd6:	ecce                	sd	s3,88(sp)
ffffffffc0203dd8:	f466                	sd	s9,40(sp)
ffffffffc0203dda:	ec6e                	sd	s11,24(sp)
ffffffffc0203ddc:	892a                	mv	s2,a0
ffffffffc0203dde:	84ae                	mv	s1,a1
ffffffffc0203de0:	8d32                	mv	s10,a2
ffffffffc0203de2:	8ab6                	mv	s5,a3
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203de4:	5b7d                	li	s6,-1
        lflag = altflag = 0;

    reswitch:
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203de6:	00002a17          	auipc	s4,0x2
ffffffffc0203dea:	0a2a0a13          	addi	s4,s4,162 # ffffffffc0205e88 <default_pmm_manager+0xe80>
            ...
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203dee:	05e00b93          	li	s7,94
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203df2:	00002c17          	auipc	s8,0x2
ffffffffc0203df6:	1eec0c13          	addi	s8,s8,494 # ffffffffc0205fe0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203dfa:	000d4503          	lbu	a0,0(s10)
ffffffffc0203dfe:	02500793          	li	a5,37
ffffffffc0203e02:	001d0413          	addi	s0,s10,1
ffffffffc0203e06:	00f50e63          	beq	a0,a5,ffffffffc0203e22 <vprintfmt+0x62>
            if (ch == '\0') {
ffffffffc0203e0a:	c521                	beqz	a0,ffffffffc0203e52 <vprintfmt+0x92>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203e0c:	02500993          	li	s3,37
ffffffffc0203e10:	a011                	j	ffffffffc0203e14 <vprintfmt+0x54>
            if (ch == '\0') {
ffffffffc0203e12:	c121                	beqz	a0,ffffffffc0203e52 <vprintfmt+0x92>
            putch(ch, putdat);
ffffffffc0203e14:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203e16:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203e18:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203e1a:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203e1e:	ff351ae3          	bne	a0,s3,ffffffffc0203e12 <vprintfmt+0x52>
ffffffffc0203e22:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203e26:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203e2a:	4981                	li	s3,0
ffffffffc0203e2c:	4801                	li	a6,0
        width = precision = -1;
ffffffffc0203e2e:	5cfd                	li	s9,-1
ffffffffc0203e30:	5dfd                	li	s11,-1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203e32:	05500593          	li	a1,85
                if (ch < '0' || ch > '9') {
ffffffffc0203e36:	4525                	li	a0,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203e38:	fdd6069b          	addiw	a3,a2,-35
ffffffffc0203e3c:	0ff6f693          	andi	a3,a3,255
ffffffffc0203e40:	00140d13          	addi	s10,s0,1
ffffffffc0203e44:	20d5e563          	bltu	a1,a3,ffffffffc020404e <vprintfmt+0x28e>
ffffffffc0203e48:	068a                	slli	a3,a3,0x2
ffffffffc0203e4a:	96d2                	add	a3,a3,s4
ffffffffc0203e4c:	4294                	lw	a3,0(a3)
ffffffffc0203e4e:	96d2                	add	a3,a3,s4
ffffffffc0203e50:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203e52:	70e6                	ld	ra,120(sp)
ffffffffc0203e54:	7446                	ld	s0,112(sp)
ffffffffc0203e56:	74a6                	ld	s1,104(sp)
ffffffffc0203e58:	7906                	ld	s2,96(sp)
ffffffffc0203e5a:	69e6                	ld	s3,88(sp)
ffffffffc0203e5c:	6a46                	ld	s4,80(sp)
ffffffffc0203e5e:	6aa6                	ld	s5,72(sp)
ffffffffc0203e60:	6b06                	ld	s6,64(sp)
ffffffffc0203e62:	7be2                	ld	s7,56(sp)
ffffffffc0203e64:	7c42                	ld	s8,48(sp)
ffffffffc0203e66:	7ca2                	ld	s9,40(sp)
ffffffffc0203e68:	7d02                	ld	s10,32(sp)
ffffffffc0203e6a:	6de2                	ld	s11,24(sp)
ffffffffc0203e6c:	6109                	addi	sp,sp,128
ffffffffc0203e6e:	8082                	ret
    if (lflag >= 2) {
ffffffffc0203e70:	4705                	li	a4,1
ffffffffc0203e72:	008a8593          	addi	a1,s5,8
ffffffffc0203e76:	01074463          	blt	a4,a6,ffffffffc0203e7e <vprintfmt+0xbe>
    else if (lflag) {
ffffffffc0203e7a:	26080363          	beqz	a6,ffffffffc02040e0 <vprintfmt+0x320>
        return va_arg(*ap, unsigned long);
ffffffffc0203e7e:	000ab603          	ld	a2,0(s5)
ffffffffc0203e82:	46c1                	li	a3,16
ffffffffc0203e84:	8aae                	mv	s5,a1
ffffffffc0203e86:	a06d                	j	ffffffffc0203f30 <vprintfmt+0x170>
            goto reswitch;
ffffffffc0203e88:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0203e8c:	4985                	li	s3,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203e8e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203e90:	b765                	j	ffffffffc0203e38 <vprintfmt+0x78>
            putch(va_arg(ap, int), putdat);
ffffffffc0203e92:	000aa503          	lw	a0,0(s5)
ffffffffc0203e96:	85a6                	mv	a1,s1
ffffffffc0203e98:	0aa1                	addi	s5,s5,8
ffffffffc0203e9a:	9902                	jalr	s2
            break;
ffffffffc0203e9c:	bfb9                	j	ffffffffc0203dfa <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203e9e:	4705                	li	a4,1
ffffffffc0203ea0:	008a8993          	addi	s3,s5,8
ffffffffc0203ea4:	01074463          	blt	a4,a6,ffffffffc0203eac <vprintfmt+0xec>
    else if (lflag) {
ffffffffc0203ea8:	22080463          	beqz	a6,ffffffffc02040d0 <vprintfmt+0x310>
        return va_arg(*ap, long);
ffffffffc0203eac:	000ab403          	ld	s0,0(s5)
            if ((long long)num < 0) {
ffffffffc0203eb0:	24044463          	bltz	s0,ffffffffc02040f8 <vprintfmt+0x338>
            num = getint(&ap, lflag);
ffffffffc0203eb4:	8622                	mv	a2,s0
ffffffffc0203eb6:	8ace                	mv	s5,s3
ffffffffc0203eb8:	46a9                	li	a3,10
ffffffffc0203eba:	a89d                	j	ffffffffc0203f30 <vprintfmt+0x170>
            err = va_arg(ap, int);
ffffffffc0203ebc:	000aa783          	lw	a5,0(s5)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203ec0:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0203ec2:	0aa1                	addi	s5,s5,8
            if (err < 0) {
ffffffffc0203ec4:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0203ec8:	8fb5                	xor	a5,a5,a3
ffffffffc0203eca:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203ece:	1ad74363          	blt	a4,a3,ffffffffc0204074 <vprintfmt+0x2b4>
ffffffffc0203ed2:	00369793          	slli	a5,a3,0x3
ffffffffc0203ed6:	97e2                	add	a5,a5,s8
ffffffffc0203ed8:	639c                	ld	a5,0(a5)
ffffffffc0203eda:	18078d63          	beqz	a5,ffffffffc0204074 <vprintfmt+0x2b4>
                printfmt(putch, putdat, "%s", p);
ffffffffc0203ede:	86be                	mv	a3,a5
ffffffffc0203ee0:	00002617          	auipc	a2,0x2
ffffffffc0203ee4:	1e860613          	addi	a2,a2,488 # ffffffffc02060c8 <error_string+0xe8>
ffffffffc0203ee8:	85a6                	mv	a1,s1
ffffffffc0203eea:	854a                	mv	a0,s2
ffffffffc0203eec:	240000ef          	jal	ra,ffffffffc020412c <printfmt>
ffffffffc0203ef0:	b729                	j	ffffffffc0203dfa <vprintfmt+0x3a>
            lflag ++;
ffffffffc0203ef2:	00144603          	lbu	a2,1(s0)
ffffffffc0203ef6:	2805                	addiw	a6,a6,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ef8:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203efa:	bf3d                	j	ffffffffc0203e38 <vprintfmt+0x78>
    if (lflag >= 2) {
ffffffffc0203efc:	4705                	li	a4,1
ffffffffc0203efe:	008a8593          	addi	a1,s5,8
ffffffffc0203f02:	01074463          	blt	a4,a6,ffffffffc0203f0a <vprintfmt+0x14a>
    else if (lflag) {
ffffffffc0203f06:	1e080263          	beqz	a6,ffffffffc02040ea <vprintfmt+0x32a>
        return va_arg(*ap, unsigned long);
ffffffffc0203f0a:	000ab603          	ld	a2,0(s5)
ffffffffc0203f0e:	46a1                	li	a3,8
ffffffffc0203f10:	8aae                	mv	s5,a1
ffffffffc0203f12:	a839                	j	ffffffffc0203f30 <vprintfmt+0x170>
            putch('0', putdat);
ffffffffc0203f14:	03000513          	li	a0,48
ffffffffc0203f18:	85a6                	mv	a1,s1
ffffffffc0203f1a:	e03e                	sd	a5,0(sp)
ffffffffc0203f1c:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0203f1e:	85a6                	mv	a1,s1
ffffffffc0203f20:	07800513          	li	a0,120
ffffffffc0203f24:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203f26:	0aa1                	addi	s5,s5,8
ffffffffc0203f28:	ff8ab603          	ld	a2,-8(s5)
            goto number;
ffffffffc0203f2c:	6782                	ld	a5,0(sp)
ffffffffc0203f2e:	46c1                	li	a3,16
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0203f30:	876e                	mv	a4,s11
ffffffffc0203f32:	85a6                	mv	a1,s1
ffffffffc0203f34:	854a                	mv	a0,s2
ffffffffc0203f36:	e1fff0ef          	jal	ra,ffffffffc0203d54 <printnum>
            break;
ffffffffc0203f3a:	b5c1                	j	ffffffffc0203dfa <vprintfmt+0x3a>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203f3c:	000ab603          	ld	a2,0(s5)
ffffffffc0203f40:	0aa1                	addi	s5,s5,8
ffffffffc0203f42:	1c060663          	beqz	a2,ffffffffc020410e <vprintfmt+0x34e>
            if (width > 0 && padc != '-') {
ffffffffc0203f46:	00160413          	addi	s0,a2,1
ffffffffc0203f4a:	17b05c63          	blez	s11,ffffffffc02040c2 <vprintfmt+0x302>
ffffffffc0203f4e:	02d00593          	li	a1,45
ffffffffc0203f52:	14b79263          	bne	a5,a1,ffffffffc0204096 <vprintfmt+0x2d6>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203f56:	00064783          	lbu	a5,0(a2)
ffffffffc0203f5a:	0007851b          	sext.w	a0,a5
ffffffffc0203f5e:	c905                	beqz	a0,ffffffffc0203f8e <vprintfmt+0x1ce>
ffffffffc0203f60:	000cc563          	bltz	s9,ffffffffc0203f6a <vprintfmt+0x1aa>
ffffffffc0203f64:	3cfd                	addiw	s9,s9,-1
ffffffffc0203f66:	036c8263          	beq	s9,s6,ffffffffc0203f8a <vprintfmt+0x1ca>
                    putch('?', putdat);
ffffffffc0203f6a:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203f6c:	18098463          	beqz	s3,ffffffffc02040f4 <vprintfmt+0x334>
ffffffffc0203f70:	3781                	addiw	a5,a5,-32
ffffffffc0203f72:	18fbf163          	bleu	a5,s7,ffffffffc02040f4 <vprintfmt+0x334>
                    putch('?', putdat);
ffffffffc0203f76:	03f00513          	li	a0,63
ffffffffc0203f7a:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203f7c:	0405                	addi	s0,s0,1
ffffffffc0203f7e:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203f82:	3dfd                	addiw	s11,s11,-1
ffffffffc0203f84:	0007851b          	sext.w	a0,a5
ffffffffc0203f88:	fd61                	bnez	a0,ffffffffc0203f60 <vprintfmt+0x1a0>
            for (; width > 0; width --) {
ffffffffc0203f8a:	e7b058e3          	blez	s11,ffffffffc0203dfa <vprintfmt+0x3a>
...
ffffffffc0203f96:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0203f98:	e60d81e3          	beqz	s11,ffffffffc0203dfa <vprintfmt+0x3a>
ffffffffc0203f9c:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0203f9e:	85a6                	mv	a1,s1
ffffffffc0203fa0:	02000513          	li	a0,32
ffffffffc0203fa4:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0203fa6:	fe0d94e3          	bnez	s11,ffffffffc0203f8e <vprintfmt+0x1ce>
ffffffffc0203faa:	bd81                	j	ffffffffc0203dfa <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203fac:	4705                	li	a4,1
ffffffffc0203fae:	008a8593          	addi	a1,s5,8
ffffffffc0203fb2:	01074463          	blt	a4,a6,ffffffffc0203fba <vprintfmt+0x1fa>
    else if (lflag) {
ffffffffc0203fb6:	12080063          	beqz	a6,ffffffffc02040d6 <vprintfmt+0x316>
        return va_arg(*ap, unsigned long);
ffffffffc0203fba:	000ab603          	ld	a2,0(s5)
ffffffffc0203fbe:	46a9                	li	a3,10
ffffffffc0203fc0:	8aae                	mv	s5,a1
ffffffffc0203fc2:	b7bd                	j	ffffffffc0203f30 <vprintfmt+0x170>
ffffffffc0203fc4:	00144603          	lbu	a2,1(s0)
            padc = '-';
ffffffffc0203fc8:	02d00793          	li	a5,45
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fcc:	846a                	mv	s0,s10
ffffffffc0203fce:	b5ad                	j	ffffffffc0203e38 <vprintfmt+0x78>
            putch(ch, putdat);
ffffffffc0203fd0:	85a6                	mv	a1,s1
ffffffffc0203fd2:	02500513          	li	a0,37
ffffffffc0203fd6:	9902                	jalr	s2
            break;
ffffffffc0203fd8:	b50d                	j	ffffffffc0203dfa <vprintfmt+0x3a>
            precision = va_arg(ap, int);
ffffffffc0203fda:	000aac83          	lw	s9,0(s5)
            goto process_precision;
ffffffffc0203fde:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0203fe2:	0aa1                	addi	s5,s5,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fe4:	846a                	mv	s0,s10
            if (width < 0)
ffffffffc0203fe6:	e40dd9e3          	bgez	s11,ffffffffc0203e38 <vprintfmt+0x78>
                width = precision, precision = -1;
ffffffffc0203fea:	8de6                	mv	s11,s9
ffffffffc0203fec:	5cfd                	li	s9,-1
ffffffffc0203fee:	b5a9                	j	ffffffffc0203e38 <vprintfmt+0x78>
            goto reswitch;
ffffffffc0203ff0:	00144603          	lbu	a2,1(s0)
            padc = '0';
ffffffffc0203ff4:	03000793          	li	a5,48
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ff8:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203ffa:	bd3d                	j	ffffffffc0203e38 <vprintfmt+0x78>
                precision = precision * 10 + ch - '0';
ffffffffc0203ffc:	fd060c9b          	addiw	s9,a2,-48
                ch = *fmt;
...
ffffffffc0204006:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc020400a:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc020400e:	fcd56ce3          	bltu	a0,a3,ffffffffc0203fe6 <vprintfmt+0x226>
            for (precision = 0; ; ++ fmt) {
ffffffffc0204012:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204014:	002c969b          	slliw	a3,s9,0x2
                ch = *fmt;
ffffffffc0204018:	00044603          	lbu	a2,0(s0)
                precision = precision * 10 + ch - '0';
ffffffffc020401c:	0196873b          	addw	a4,a3,s9
ffffffffc0204020:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204024:	0117073b          	addw	a4,a4,a7
                if (ch < '0' || ch > '9') {
ffffffffc0204028:	fd06069b          	addiw	a3,a2,-48
                precision = precision * 10 + ch - '0';
ffffffffc020402c:	fd070c9b          	addiw	s9,a4,-48
                ch = *fmt;
ffffffffc0204030:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204034:	fcd57fe3          	bleu	a3,a0,ffffffffc0204012 <vprintfmt+0x252>
ffffffffc0204038:	b77d                	j	ffffffffc0203fe6 <vprintfmt+0x226>
            if (width < 0)
ffffffffc020403a:	fffdc693          	not	a3,s11
ffffffffc020403e:	96fd                	srai	a3,a3,0x3f
ffffffffc0204040:	00ddfdb3          	and	s11,s11,a3
ffffffffc0204044:	00144603          	lbu	a2,1(s0)
ffffffffc0204048:	2d81                	sext.w	s11,s11
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020404a:	846a                	mv	s0,s10
ffffffffc020404c:	b3f5                	j	ffffffffc0203e38 <vprintfmt+0x78>
            putch('%', putdat);
ffffffffc020404e:	85a6                	mv	a1,s1
ffffffffc0204050:	02500513          	li	a0,37
ffffffffc0204054:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204056:	fff44703          	lbu	a4,-1(s0)
ffffffffc020405a:	02500793          	li	a5,37
ffffffffc020405e:	8d22                	mv	s10,s0
ffffffffc0204060:	d8f70de3          	beq	a4,a5,ffffffffc0203dfa <vprintfmt+0x3a>
ffffffffc0204064:	02500713          	li	a4,37
ffffffffc0204068:	1d7d                	addi	s10,s10,-1
ffffffffc020406a:	fffd4783          	lbu	a5,-1(s10)
ffffffffc020406e:	fee79de3          	bne	a5,a4,ffffffffc0204068 <vprintfmt+0x2a8>
ffffffffc0204072:	b361                	j	ffffffffc0203dfa <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204074:	00002617          	auipc	a2,0x2
ffffffffc0204078:	04460613          	addi	a2,a2,68 # ffffffffc02060b8 <error_string+0xd8>
ffffffffc020407c:	85a6                	mv	a1,s1
ffffffffc020407e:	854a                	mv	a0,s2
ffffffffc0204080:	0ac000ef          	jal	ra,ffffffffc020412c <printfmt>
ffffffffc0204084:	bb9d                	j	ffffffffc0203dfa <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204086:	00002617          	auipc	a2,0x2
ffffffffc020408a:	02a60613          	addi	a2,a2,42 # ffffffffc02060b0 <error_string+0xd0>
            if (width > 0 && padc != '-') {
ffffffffc020408e:	00002417          	auipc	s0,0x2
ffffffffc0204092:	02340413          	addi	s0,s0,35 # ffffffffc02060b1 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204096:	8532                	mv	a0,a2
ffffffffc0204098:	85e6                	mv	a1,s9
ffffffffc020409a:	e032                	sd	a2,0(sp)
ffffffffc020409c:	e43e                	sd	a5,8(sp)
ffffffffc020409e:	18a000ef          	jal	ra,ffffffffc0204228 <strnlen>
ffffffffc02040a2:	40ad8dbb          	subw	s11,s11,a0
ffffffffc02040a6:	6602                	ld	a2,0(sp)
ffffffffc02040a8:	01b05d63          	blez	s11,ffffffffc02040c2 <vprintfmt+0x302>
ffffffffc02040ac:	67a2                	ld	a5,8(sp)
ffffffffc02040ae:	2781                	sext.w	a5,a5
ffffffffc02040b0:	e43e                	sd	a5,8(sp)
                    putch(padc, putdat);
ffffffffc02040b2:	6522                	ld	a0,8(sp)
...
ffffffffc02040ba:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02040bc:	6602                	ld	a2,0(sp)
ffffffffc02040be:	fe0d9ae3          	bnez	s11,ffffffffc02040b2 <vprintfmt+0x2f2>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02040c2:	00064783          	lbu	a5,0(a2)
ffffffffc02040c6:	0007851b          	sext.w	a0,a5
ffffffffc02040ca:	e8051be3          	bnez	a0,ffffffffc0203f60 <vprintfmt+0x1a0>
ffffffffc02040ce:	b335                	j	ffffffffc0203dfa <vprintfmt+0x3a>
        return va_arg(*ap, int);
ffffffffc02040d0:	000aa403          	lw	s0,0(s5)
ffffffffc02040d4:	bbf1                	j	ffffffffc0203eb0 <vprintfmt+0xf0>
        return va_arg(*ap, unsigned int);
ffffffffc02040d6:	000ae603          	lwu	a2,0(s5)
ffffffffc02040da:	46a9                	li	a3,10
ffffffffc02040dc:	8aae                	mv	s5,a1
ffffffffc02040de:	bd89                	j	ffffffffc0203f30 <vprintfmt+0x170>
ffffffffc02040e0:	000ae603          	lwu	a2,0(s5)
ffffffffc02040e4:	46c1                	li	a3,16
ffffffffc02040e6:	8aae                	mv	s5,a1
ffffffffc02040e8:	b5a1                	j	ffffffffc0203f30 <vprintfmt+0x170>
ffffffffc02040ea:	000ae603          	lwu	a2,0(s5)
ffffffffc02040ee:	46a1                	li	a3,8
ffffffffc02040f0:	8aae                	mv	s5,a1
ffffffffc02040f2:	bd3d                	j	ffffffffc0203f30 <vprintfmt+0x170>
                    putch(ch, putdat);
ffffffffc02040f4:	9902                	jalr	s2
ffffffffc02040f6:	b559                	j	ffffffffc0203f7c <vprintfmt+0x1bc>
                putch('-', putdat);
ffffffffc02040f8:	85a6                	mv	a1,s1
ffffffffc02040fa:	02d00513          	li	a0,45
ffffffffc02040fe:	e03e                	sd	a5,0(sp)
ffffffffc0204100:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204102:	8ace                	mv	s5,s3
ffffffffc0204104:	40800633          	neg	a2,s0
ffffffffc0204108:	46a9                	li	a3,10
ffffffffc020410a:	6782                	ld	a5,0(sp)
ffffffffc020410c:	b515                	j	ffffffffc0203f30 <vprintfmt+0x170>
            if (width > 0 && padc != '-') {
ffffffffc020410e:	01b05663          	blez	s11,ffffffffc020411a <vprintfmt+0x35a>
ffffffffc0204112:	02d00693          	li	a3,45
ffffffffc0204116:	f6d798e3          	bne	a5,a3,ffffffffc0204086 <vprintfmt+0x2c6>
ffffffffc020411a:	00002417          	auipc	s0,0x2
ffffffffc020411e:	f9740413          	addi	s0,s0,-105 # ffffffffc02060b1 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204122:	02800513          	li	a0,40
ffffffffc0204126:	02800793          	li	a5,40
ffffffffc020412a:	bd1d                	j	ffffffffc0203f60 <vprintfmt+0x1a0>

ffffffffc020412c <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020412c:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc020412e:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204132:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204134:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204136:	ec06                	sd	ra,24(sp)
ffffffffc0204138:	f83a                	sd	a4,48(sp)
ffffffffc020413a:	fc3e                	sd	a5,56(sp)
ffffffffc020413c:	e0c2                	sd	a6,64(sp)
ffffffffc020413e:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204140:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204142:	c7fff0ef          	jal	ra,ffffffffc0203dc0 <vprintfmt>
}
ffffffffc0204146:	60e2                	ld	ra,24(sp)
ffffffffc0204148:	6161                	addi	sp,sp,80
ffffffffc020414a:	8082                	ret

ffffffffc020414c <readline>:
...
ffffffffc020414c:	715d                	addi	sp,sp,-80
ffffffffc020414e:	e486                	sd	ra,72(sp)
ffffffffc0204150:	e0a2                	sd	s0,64(sp)
ffffffffc0204152:	fc26                	sd	s1,56(sp)
ffffffffc0204154:	f84a                	sd	s2,48(sp)
ffffffffc0204156:	f44e                	sd	s3,40(sp)
ffffffffc0204158:	f052                	sd	s4,32(sp)
ffffffffc020415a:	ec56                	sd	s5,24(sp)
ffffffffc020415c:	e85a                	sd	s6,16(sp)
ffffffffc020415e:	e45e                	sd	s7,8(sp)
    if (prompt != NULL) {
ffffffffc0204160:	c901                	beqz	a0,ffffffffc0204170 <readline+0x24>
        cprintf("%s", prompt);
ffffffffc0204162:	85aa                	mv	a1,a0
ffffffffc0204164:	00002517          	auipc	a0,0x2
ffffffffc0204168:	f6450513          	addi	a0,a0,-156 # ffffffffc02060c8 <error_string+0xe8>
ffffffffc020416c:	f53fb0ef          	jal	ra,ffffffffc02000be <cprintf>
readline(const char *prompt) {
ffffffffc0204170:	4481                	li	s1,0
    while (1) {
        c = getchar();
        if (c < 0) {
            return NULL;
...
ffffffffc0204172:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc0204174:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc0204176:	4aa9                	li	s5,10
ffffffffc0204178:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc020417a:	0000db97          	auipc	s7,0xd
ffffffffc020417e:	ec6b8b93          	addi	s7,s7,-314 # ffffffffc0211040 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204182:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc0204186:	f71fb0ef          	jal	ra,ffffffffc02000f6 <getchar>
ffffffffc020418a:	842a                	mv	s0,a0
        if (c < 0) {
ffffffffc020418c:	00054b63          	bltz	a0,ffffffffc02041a2 <readline+0x56>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204190:	00a95b63          	ble	a0,s2,ffffffffc02041a6 <readline+0x5a>
ffffffffc0204194:	029a5463          	ble	s1,s4,ffffffffc02041bc <readline+0x70>
        c = getchar();
ffffffffc0204198:	f5ffb0ef          	jal	ra,ffffffffc02000f6 <getchar>
ffffffffc020419c:	842a                	mv	s0,a0
        if (c < 0) {
ffffffffc020419e:	fe0559e3          	bgez	a0,ffffffffc0204190 <readline+0x44>
            return NULL;
ffffffffc02041a2:	4501                	li	a0,0
ffffffffc02041a4:	a099                	j	ffffffffc02041ea <readline+0x9e>
        else if (c == '\b' && i > 0) {
ffffffffc02041a6:	03341463          	bne	s0,s3,ffffffffc02041ce <readline+0x82>
ffffffffc02041aa:	e8b9                	bnez	s1,ffffffffc0204200 <readline+0xb4>
        c = getchar();
ffffffffc02041ac:	f4bfb0ef          	jal	ra,ffffffffc02000f6 <getchar>
ffffffffc02041b0:	842a                	mv	s0,a0
        if (c < 0) {
ffffffffc02041b2:	fe0548e3          	bltz	a0,ffffffffc02041a2 <readline+0x56>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02041b6:	fea958e3          	ble	a0,s2,ffffffffc02041a6 <readline+0x5a>
ffffffffc02041ba:	4481                	li	s1,0
            cputchar(c);
ffffffffc02041bc:	8522                	mv	a0,s0
ffffffffc02041be:	f35fb0ef          	jal	ra,ffffffffc02000f2 <cputchar>
            buf[i ++] = c;
ffffffffc02041c2:	009b87b3          	add	a5,s7,s1
ffffffffc02041c6:	00878023          	sb	s0,0(a5)
ffffffffc02041ca:	2485                	addiw	s1,s1,1
ffffffffc02041cc:	bf6d                	j	ffffffffc0204186 <readline+0x3a>
        else if (c == '\n' || c == '\r') {
ffffffffc02041ce:	01540463          	beq	s0,s5,ffffffffc02041d6 <readline+0x8a>
ffffffffc02041d2:	fb641ae3          	bne	s0,s6,ffffffffc0204186 <readline+0x3a>
            cputchar(c);
ffffffffc02041d6:	8522                	mv	a0,s0
ffffffffc02041d8:	f1bfb0ef          	jal	ra,ffffffffc02000f2 <cputchar>
            buf[i] = '\0';
ffffffffc02041dc:	0000d517          	auipc	a0,0xd
ffffffffc02041e0:	e6450513          	addi	a0,a0,-412 # ffffffffc0211040 <buf>
ffffffffc02041e4:	94aa                	add	s1,s1,a0
ffffffffc02041e6:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc02041ea:	60a6                	ld	ra,72(sp)
ffffffffc02041ec:	6406                	ld	s0,64(sp)
ffffffffc02041ee:	74e2                	ld	s1,56(sp)
ffffffffc02041f0:	7942                	ld	s2,48(sp)
ffffffffc02041f2:	79a2                	ld	s3,40(sp)
ffffffffc02041f4:	7a02                	ld	s4,32(sp)
ffffffffc02041f6:	6ae2                	ld	s5,24(sp)
ffffffffc02041f8:	6b42                	ld	s6,16(sp)
ffffffffc02041fa:	6ba2                	ld	s7,8(sp)
ffffffffc02041fc:	6161                	addi	sp,sp,80
ffffffffc02041fe:	8082                	ret
            cputchar(c);
ffffffffc0204200:	4521                	li	a0,8
ffffffffc0204202:	ef1fb0ef          	jal	ra,ffffffffc02000f2 <cputchar>
            i --;
ffffffffc0204206:	34fd                	addiw	s1,s1,-1
ffffffffc0204208:	bfbd                	j	ffffffffc0204186 <readline+0x3a>

ffffffffc020420a <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc020420a:	00054783          	lbu	a5,0(a0)
ffffffffc020420e:	cb91                	beqz	a5,ffffffffc0204222 <strlen+0x18>
    size_t cnt = 0;
ffffffffc0204210:	4781                	li	a5,0
        cnt ++;
ffffffffc0204212:	0785                	addi	a5,a5,1
    while (*s ++ != '\0') {
ffffffffc0204214:	00f50733          	add	a4,a0,a5
ffffffffc0204218:	00074703          	lbu	a4,0(a4)
ffffffffc020421c:	fb7d                	bnez	a4,ffffffffc0204212 <strlen+0x8>
    }
    return cnt;
}
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204228:	c185                	beqz	a1,ffffffffc0204248 <strnlen+0x20>
ffffffffc020422a:	00054783          	lbu	a5,0(a0)
ffffffffc020422e:	cf89                	beqz	a5,ffffffffc0204248 <strnlen+0x20>
    size_t cnt = 0;
ffffffffc0204230:	4781                	li	a5,0
ffffffffc0204232:	a021                	j	ffffffffc020423a <strnlen+0x12>
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204234:	00074703          	lbu	a4,0(a4)
ffffffffc0204238:	c711                	beqz	a4,ffffffffc0204244 <strnlen+0x1c>
        cnt ++;
ffffffffc020423a:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc020423c:	00f50733          	add	a4,a0,a5
ffffffffc0204240:	fef59ae3          	bne	a1,a5,ffffffffc0204234 <strnlen+0xc>
    }
    return cnt;
}
...
#else
    char *p = dst;
ffffffffc020424e:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204250:	0585                	addi	a1,a1,1
ffffffffc0204252:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0204256:	0785                	addi	a5,a5,1
ffffffffc0204258:	fee78fa3          	sb	a4,-1(a5)
ffffffffc020425c:	fb75                	bnez	a4,ffffffffc0204250 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204268:	cb91                	beqz	a5,ffffffffc020427c <strcmp+0x1c>
ffffffffc020426a:	00e79c63          	bne	a5,a4,ffffffffc0204282 <strcmp+0x22>
        s1 ++, s2 ++;
...
ffffffffc0204276:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020427a:	fbe5                	bnez	a5,ffffffffc020426a <strcmp+0xa>
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc020427c:	4501                	li	a0,0
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc020427e:	9d19                	subw	a0,a0,a4
...
ffffffffc020428e:	cb91                	beqz	a5,ffffffffc02042a2 <strchr+0x18>
        if (*s == c) {
ffffffffc0204290:	00b79563          	bne	a5,a1,ffffffffc020429a <strchr+0x10>
ffffffffc0204294:	a809                	j	ffffffffc02042a6 <strchr+0x1c>
ffffffffc0204296:	00b78763          	beq	a5,a1,ffffffffc02042a4 <strchr+0x1a>
            return (char *)s;
        }
        s ++;
ffffffffc020429a:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc020429c:	00054783          	lbu	a5,0(a0)
ffffffffc02042a0:	fbfd                	bnez	a5,ffffffffc0204296 <strchr+0xc>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc02042a8:	ca01                	beqz	a2,ffffffffc02042b8 <memset+0x10>
ffffffffc02042aa:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc02042ac:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc02042ae:	0785                	addi	a5,a5,1
ffffffffc02042b0:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02042b4:	fec79de3          	bne	a5,a2,ffffffffc02042ae <memset+0x6>
    }
    return s;
...
ffffffffc02042ba <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02042ba:	ca19                	beqz	a2,ffffffffc02042d0 <memcpy+0x16>
ffffffffc02042bc:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02042be:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02042c0:	0585                	addi	a1,a1,1
ffffffffc02042c2:	fff5c703          	lbu	a4,-1(a1)
ffffffffc02042c6:	0785                	addi	a5,a5,1
ffffffffc02042c8:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02042cc:	fec59ae3          	bne	a1,a2,ffffffffc02042c0 <memcpy+0x6>
    }
    return dst;
